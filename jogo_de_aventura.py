                ...
                try:
                    ...
                    if self.pergunta1 == '\nTentar se lembrar' and str.lower(palavra) == 'lembrar':
                        if self.lembra1 == False:
                            ...
                            self.introduçao = '\n\nAquela pessoa disse que você encontraria o que mais quer aqui'
                            self.lembra4 = True
                        else:
                    ...
                    elif self.pergunta2 == '\nSair da caverna' and (str.lower(palavra) == 'sair' or str.lower(palavra) == 'saida' or str.lower(palavra) == 'saída' or str.lower(palavra) == 'embora'):
                        if self.pergunta1 == '\nTentar se lembrar':
                    ...
                    # serie da pergunta 4
                        ...
                        if self.pergunta5 == '':
                            ...
                            self.introduçao = '\n\nVocê tenta acorda-lo mas nada funciona, porém ainda está respirando. Há um ferimento na cabeça dele, provavelmente o que o desacordou'
